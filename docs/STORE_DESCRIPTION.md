...
Transform chaos into clarity: Intelligent tab organization that learns from your browsing habits and organizes automatically.
...
### 1️⃣ **Intelligent Auto-Grouping** (3-Tier Priority System)
...
- Example: "Group all tabs with 'React' in title → 🟢 React Study"
...
- No setup needed - works with your existing bookmarks
...
- Requires 2+ tabs to create a group
- Prevents tab soup from similar sites

### 2️⃣ **Instant Tab Search & Recovery**
...
- Perfect for "What was that page I just closed?"

### 3️⃣ **Visual Organization with Real Chrome Colors**

Match Chrome's native tab group colors perfectly:

🔵 Blue | 🔴 Red | 🟡 Yellow | 🟢 Green | 🟣 Purple | 🟠 Orange | 🌸 Pink | 🔵 Cyan | ⚪ Grey

- Choose colors that match your mental model
- Visual color preview in settings
- Consistent with Chrome's design language
- Easy to spot groups at a glance
...
- Edit rules anytime
- Visual rule list with color indicators
...
- Open source logic (audit the code yourself)
...
- Custom rules: "Group 'blog' URLs → 📰 Reading List"
...
2. **Grant permissions** (tabs, groups, storage, bookmarks)
3. **Start browsing** - Auto-grouping begins at 10+ tabs
4. **Optional:** Create custom rules in ⚙️ Rules tab
...
- See recently closed tabs automatically
...
- Domain equals "stackoverflow.com" → 🟠 Stack Overflow

Result: Development tabs auto-organize by context
```
...
Result: Tabs group by research topic automatically
```
...
- Title contains "review" → 🟡 Reviews

Result: Shopping tabs organized by store and research
```
...
✅ **Automatic tab organization** - No manual sorting ever again
✅ **Unlimited custom rules** - Perfect for your unique workflow
✅ **Searchable history** - Find any tab in 1,000+ entries instantly
✅ **Bookmark integration** - Leverage existing organization
✅ **Real Chrome colors** - 9 native tab group colors
✅ **Privacy guaranteed** - 100% local, zero tracking
✅ **Keyboard shortcuts** - Alt+S search, Alt+G group
✅ **Open/closed detection** - Smart tab status tracking
✅ **Recently closed** - Quick access to last 10 closed tabs
✅ **Visual organization** - Color-coded groups
✅ **Manual control** - One-click re-grouping
...
**Q: Does this slow down Chrome?**
A: No! Uses efficient algorithms, debouncing, and Chrome's native APIs. Minimal memory impact.

**Q: Can I customize grouping rules?**
A: Yes! Create unlimited custom rules with your own colors, matching by title/URL/domain.

**Q: Does it sync across devices?**
A: Currently local-only for privacy. Cloud sync may come in future updates.

**Q: What happens to my existing tab groups?**
A: Existing groups are preserved. New groups are only created when needed.

**Q: Can I disable auto-grouping?**
A: Yes! Works manually too. Use the Alt+G shortcut or button to group on-demand.

**Q: Is my browsing data private?**
A: Absolutely! Everything stays on your computer. No external servers, no tracking, no cloud.

**Q: How many tabs can it handle?**
A: Tested with 100+ tabs. Stores 1,000 tab history entries. Scales well.

**Q: Can I change the tab threshold?**
A: Yes! Edit CONFIG.TAB_THRESHOLD in background.js (default: 10 tabs).

---

## 🎁 Bonus Features

- **Time formatting:** Human-readable timestamps (5m ago, 2h ago, 3d ago)
- **Highlight matching text:** See exactly what matched your search
- **Duplicate prevention:** Never creates redundant groups
- **Pinned tab exclusion:** Pinned tabs stay ungrouped
- **Empty state handling:** Helpful messages when nothing to show
- **Confirmation dialogs:** Prevents accidental data loss
- **Error recovery:** Try/catch throughout for stability
...
3. **Start browsing** - Auto-grouping activates at 10+ tabs
4. **Optional:** Press Alt+S to search, Alt+G to manually group
5. **Customize:** Create rules in ⚙️ Rules tab

Transform your chaotic browser into an organized productivity machine in 30 seconds.
...
- **Questions:** Contact us at yuyeon116@gmail.com
...
Transparent, auditable code. Review the logic yourself for peace of mind.
