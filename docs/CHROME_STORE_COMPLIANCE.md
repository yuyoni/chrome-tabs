...
Smart Tab Memory ("the Extension") does NOT collect, store, or transmit any personal information to external servers. All data processing occurs locally within your browser.
...
Smart Tab Memory is a privacy-first extension that:
